...
------- Your tasks:
1. Calculate the average score foreach team,using the test data below
...
dolphinAverageScore = (86 + 108 + 89) / 3;
koalasAverageScore = (86 + 108 + 89) / 3;

console.log('Dolphin: ' + dolphinAverageScore);
console.log('Koala: ' + koalasAverageScore);
...
//     console.log('It was a tie');
// } else {
//     console.log('Nobody scored over 100')
// }

if (dolphinAverageScore <= 100 && koalasAverageScore <= 100) {
    console.log('Nobody scored more than 100 points');
} else if (dolphinAverageScore < koalasAverageScore) {
    console.log('The Koalas Win!');
} else if (dolphinAverageScore > koalasAverageScore) {
    console.log('The Dolphins Win!');
